...
--
-- Структура таблицы `notification_outbox`
--
...
--
-- Демо-данные таблицы `notification_outbox` удалены перед публикацией в git.
--
...
--
-- Индексы таблицы `notification_outbox`
--
ALTER TABLE `notification_outbox`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_notification_outbox_due` (`delivery_state`,`next_attempt_at`);
...
--
-- AUTO_INCREMENT для таблицы `notification_outbox`
--
ALTER TABLE `notification_outbox`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
